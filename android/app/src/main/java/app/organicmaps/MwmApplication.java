...
import com.mapmetrics.orgmaps.R;
...
public class MwmApplication extends FlutterApplication implements AppBackgroundTracker.OnTransitionListener
{
  ...
  private void initNativePlatform() throws IOException
  {
    ...
    nativeInitPlatform(apkPath,
                       ...
                       tempPath,
                       "release",
                       com.mapmetrics.orgmaps.BuildConfig.BUILD_TYPE, UiUtils.isTablet(this));
